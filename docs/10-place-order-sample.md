...
This is a documentation-first design. A static TypeScript model/report sample and an educational deterministic mock runtime now exist for the planned PlaceOrder scenarios.
