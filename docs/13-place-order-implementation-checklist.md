...
Initial status: happy-path, `inventory-reservation-fails`, and `payment-authorization-fails` runtime slices exist. Other non-happy-path scenarios remain guarded until implemented.
